...
export default function PostDetailModal({
  ...
  async function handleDelete() {
    ...
    try {
      ...
      const msg = (err as { response?: { data?: { message?: string } } })?.response?.data?.message
      setDeleteError(msg ?? 'Failed to delete post.')
      setDeleting(false)
    ...
    <div className="pdm-overlay" onClick={(e) => { if (e.target === e.currentTarget) onClose() }}>
      <div className="pdm-modal" role="dialog" aria-modal="true">
        ...
        <div className="pdm-header">
          ...
          {isOwner && (
            <div className="pdm-owner-actions">
              ...
              <button className="pdm-delete-btn" onClick={() => setDeleteConfirm(true)} aria-label="Delete post">
                <svg viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
          ...
          <div className="pdm-info">
            ...
            {(deleteConfirm || deleteError) && (
              <div className="pdm-delete-confirm">
                <div className="pdm-divider" />
                {deleteError ? (
                  <p className="pdm-feedback pdm-feedback--err">{deleteError}</p>
                ) : (
                  <>
                    <p className="pdm-delete-confirm-text">Delete this post? This cannot be undone.</p>
                    <div className="pdm-delete-confirm-actions">
                      <button
                        className="pdm-delete-cancel-btn"
                      ...
                      <button
                        className="pdm-delete-confirm-btn"
